...
def comment(body: Dict, token_info: Dict) -> Tuple[Optional[str], Optional[int]]:
...
def get_comment(username: str, id: int) -> Tuple[Union[Dict, str], Optional[int]]:
